      ...
      <a class="navbar-brand " style="margin-left:100px;" >
          <form  method="post">
               <div  class="form-control" >
                   <input type="text" style="top:1.5px; border: none;" name="search_product" placeholder="Search products"  />
              <button style="border:none;" name="search"><span style="font-size:15px;border: none" class="glyphicon glyphicon-search"></span></button>
          </div>
          </form>
