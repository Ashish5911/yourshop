...
<html>
  ...
  <div class="container  ">
        <div class="header">
            <form method="post">
                <input name="search_product" value="shirt" type="hidden">
                <button name='search' style="all:unset;"><div class="head">shirt's</div></button>
            </form>
            <form method="post">
                <input name="search_product" value="camera" type="hidden">
                <button name='search' style="all:unset;"><div class="head">camera's</div></button>
            </form><!-- comment -->
            <form method="post">
                <input name="search_product" value="watch" type="hidden">
                <button name='search' style="all:unset;"><div class="head">watch's</div></button>
            </form><!-- comment -->
            <form method="post">
                <input name="search_product" value="shoes" type="hidden">
                <button name='search' style="all:unset;"><div class="head">Shoes</div></button>
            </form>
    ...
    <div class="jumbotron top-mg lr-mg">
      ...
      <?php
        if(isset($_POST['search'])){
            ...
            $myproducts="select * from products";
        }
                                     ...
                                     ?> 
                                        ...
                                        <form action="manage_cart3.php" method="post">
                                            <div class="col-xs-6 col-sm-4 col-md-3  bdr ">
                                                <img istyle=" height: 200;" src="<?php echo $rows[3];?>" class="img-responsive img-thumbnail ">
